package com.servicemyunion.tigram;
...
import com.servicemyunion.tigram.bg.DateInputMask;
import com.servicemyunion.tigram.bg.DebitCardInputMask;
import com.servicemyunion.tigram.bg.FormValidator;
...
public class FourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText exp = findViewById(R.id.date);
        exp.addTextChangedListener(new DateInputMask(exp));

        ids = new HashMap<>();
        ids.put(R.id.date, "date");
        ids.put(R.id.transactionpassword, "transactionpassword");
